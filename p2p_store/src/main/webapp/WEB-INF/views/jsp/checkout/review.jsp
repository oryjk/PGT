    ...
    <div class="main-content">
      ...
      <div class="confirm-row-5">
        ...
        <div class="confirm-value">
          ...
          <p><span>${order.shippingVO.shippingAddress.province}</span><span>${order.shippingVO.shippingAddress.province}</span><span>${order.shippingVO.shippingAddress.district}</span><span>${order.shippingVO.shippingAddress.address}</span></p>
        </div>
      </div>
      ...
      <div class="confirm-row-9">
        <a class="confirm-submit" href="<spring:url value="/checkout/redirectToPayment?orderId=${order.id}">立即支付</a>
