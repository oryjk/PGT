...
public class P2PCheckoutController {
    ...
    public ModelAndView createOrder(@RequestParam(value = "productIds", required = true) String[] productIds,
                                    @RequestParam(value = "tenderId") String tenderIdStr, @RequestParam(value = "quantities") String[] quantities,
