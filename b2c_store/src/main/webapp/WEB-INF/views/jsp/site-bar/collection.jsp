...
<div class="n-all">
    ...
    <div class="n-content">
        ...
        <div class="n-box1">
            <a style="display: block" data-value="${fav.productId}" href="<spring:url value="${urlConfiguration.pdpPage}/${fav.productId}"/>">
                <img data-value="${fav.productId}" src="${pageContext.request.contextPath}/resources${fav['snapshotMedia']['path']}">
