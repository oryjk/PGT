			...
			<c:if test="${status.index % 2 ==0}">
				...
				<div class="products-list-cardinal">
					...
					<h2 style="border-bottom: 2px solid ${category.color}">
							${category.name}
						<small style="color: ${category.color}">${category.description}</small>
					</h2>
					<div class="products">
								...
								<a href="product/${product['productId']}">
									...
									<div class="product-hover-area" style="background: ${category.color}">
										<input type="button" value="查看详情" data-btn="showInfo"/> <input
											...
											type="button" value="加入购物车" data-value="${product['productId']}" data-url="<spring:url value="/shoppingCart/ajaxAddItemToOrder"/>"
											data-btn="addCart"/>
									</div>
								</a>
							</c:if>
