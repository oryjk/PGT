...
<div class="side-bar" id="side-bar">
  ...
  <a href="<spring:url value=""/>" class="right1">
    ...
    <div class="right2"><span>主页</span><img class="img-search"
                                            src="<spring:url value="${juedangpinStaticPath}/core/images/footer/search_17.png"/>">
    </div>
  </a>
  ...
  <div class="right-b">
    <a href="<spring:url value="/myAccount/orderHistory" />" class="right1">
      ...
      <div class="right2"><span>订单</span><img class="img-search"
                                              src="<spring:url value="${juedangpinStaticPath}/core/images/search_17.png"/>">
      </div>
    </a>
    <a href="<spring:url value="/shoppingCart/cart" />" class="right1">
      ...
      <div class="right2"><span>购物车</span><img class="img-search"
                                               src="<spring:url value="${juedangpinStaticPath}/core/images/search_17.png"/>">
      </div>
    </a>
    <a href="<spring:url value="/myAccount/favourites" />" class="right1">
      ...
      <div class="right2"><span>收藏</span><img class="img-search"
                                              src="<spring:url value="${juedangpinStaticPath}/core/images/search_17.png"/>">
      </div>
    </a>
    <a href="<spring:url value="${urlConfiguration.myAccountPage}"/>" class="right1">
      ...
      <div class="right2"><span>账户</span><img class="img-search"
                                              src="<spring:url value="${juedangpinStaticPath}/core/images/search_17.png"/>">
      </div>
    </a>
    <a href="#" class="right1">
      <img src="<spring:url value="${juedangpinStaticPath}/core/images/footer/_0005_arrow-top.png"/>">
      <div class="right2"><span>回到顶部</span><img class="img-search"
                                                src="<spring:url value="${juedangpinStaticPath}/core/images/search_17.png"/>">
      </div>
    </a>
  </div>
