            ...
            <div class="similar-box">
                ...
                <ul class="similar" id="rowList">
                   ...
                   <c:forEach items="${similarProducts}" var="product">
                    <li><a class="similar-pic-box" href="${pageContext.request.contextPath}/product/${product.productId}"><img
                            src="${pageContext.request.contextPath}/resources/${product.frontMedia.path}" alt="${product.name}" /></a> <a
                        class="similar-name" href="${pageContext.request.contextPath}/product/${product.productId}"> ${product.name} </a>
