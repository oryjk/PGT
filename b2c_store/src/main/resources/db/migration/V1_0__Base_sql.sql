...
CREATE TABLE IF NOT EXISTS  `INVESTMENT` (
  `INVEST_ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS  `LOAN_PERIOD` (
  `LOAN_PERIOD_ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS  `SETTLEMENT_CYCLE` (
  `SETTLEMENT_CYCLE_ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `DISPLAY_NAME` VARCHAR(200) NOT NULL COMMENT '',
