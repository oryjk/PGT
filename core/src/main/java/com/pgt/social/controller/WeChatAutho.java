...
public class WeChatAutho {
        ...
        public String GetWeiXinCode(String appId,String appSecret,String redirectUrl)
        {
            ...
            //微信用户信息授权
            String url = "https://open.weixin.qq.com/connect/qrconnect?appid=" + appId + "&redirect_uri=" + redirectUrl + "&response_type=code&scope=snsapi_login&state="+appSecret+"#wechat_redirect";
            return url;
        }
