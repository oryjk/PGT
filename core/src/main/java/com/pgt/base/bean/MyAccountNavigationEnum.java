...
public enum MyAccountNavigationEnum {
    MY_ORDER("我的订单", "/myAccount/orderHistory?status=0"), MY_ASSET("我的资产", "/user/yeepayAccountInfo"), MY_FAVORITE("我的收藏", "/myAccount/favourites?type=6"),
    MY_RECENT_VIEW("我的浏览", "/myAccount/browsedProducts"), MY_INFO("我的信息", "/userinformation/query"),
