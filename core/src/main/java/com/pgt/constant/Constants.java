...
public class Constants {
    ...
    public static final String LOGIN_SESSION_SECURITY_CODE = "loginSessionSecCode";
    ...
    public static final String ALL_STOCK = "3";
    public static final String HOME_PAGE = "/";
    public static final String LOGIN_PAGE = "/user/login";
    public static final String REGISTER_PAGE = "/user/register";
    public static final String URL_CONFIGURATION = "urlConfiguration";
    public static final String PLP_PAGE = "/productList/productList";
