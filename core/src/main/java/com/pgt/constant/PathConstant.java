...
public class PathConstant {
    ...
    public static String NO_LOGIN_TOKEN_PATH = ".*/((login))|.*/((logout))|.*/((updatePassword))|.*/((updatePasswordSubmit))|.*/((register))|.*/((mLogin))|.*/((mRegister))|.*/((resetPassword))|.*/((yeepayAccountInfo))|.((mHome))|.((mEssearch))/.*|.((mProduct))/.*|.((mConsulting))/((query))|.((mDiscuss))/((query))|.*/((uploadPicByPhone))|.*/((uploadPic))";
}
