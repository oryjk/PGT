...
public class PathConstant {
    ...
    public static String NO_LOGIN_INTERCEPTOR_PATH = ".*/((login))|.*/((logout))|.*/((updatePassword))|.*/((updatePasswordSubmit))|.*/((register))|.*/((mLogin))|.*/((mRegister))|.*/((resetPassword))|.*/((yeepayAccountInfo))|.*/web/.*|.*resources/static/.*";
