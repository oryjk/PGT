...
<div class="content">
    ...
    <div class="content-top ">
        ...
        <div class="ad">
            ...
            <c:if test="${i.index!=0}">
                <a href="${pageContext.request.contextPath }/web/setDefaultAddress/${address.id}">设为默认地址</a>
            </c:if>
        </div>
    </div>
    <div class="content-mid">
        ...
        <div class="content-change">
            <div class="kong3"></div>
            <a href="${pageContext.request.contextPath }/web/findAddress/${address.id}" class="content-change-font1">编辑</a>

            <c:if test="${i.index!=0}">
                <div class="kong4">|</div>
                <a href="${pageContext.request.contextPath }/web/deleteAddress/${address.id}" class="content-change-font2">删除</a>
            </c:if>
            <div class="kong4"></div>
        </div>
    </div>
...
<a class="btn-clean" href="${pageContext.request.contextPath }/web/addAddress">
    添加新地址
</a>
