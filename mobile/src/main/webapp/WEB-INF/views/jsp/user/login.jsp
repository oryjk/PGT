...
<form:form modelAttribute="user" method="post" action="${pageContext.request.contextPath }/web/wlogin" id="login">
...
<div class="font-1">
<a href="${pageContext.request.contextPath }/web/wregister" class="font1">免费注册</a>
