			...
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions btn-set">
						<button class="btn green-haze btn-circle" data-pgt-btn="create" data-url="/tender/createUI"><i class="fa fa-plus"></i> 新增</button>
						<div class="btn-group">
							...
							<table class="table table-striped table-bordered table-hover dataTable no-footer"
								...
								<c:forEach items="${tenderList}" var="tender">
									<tr class="gradeX odd" role="row">
										...
										<td>
											<button class="btn btn-xs green btn-circle" data-pgt-btn="modify" data-url="/tender/updateUI/${tender.tenderId}">
												修改
											</button>
											<button class="btn btn-xs red btn-circle" data-pgt-btn="delete" data-url="/tender/delete/${tender.tenderId}">
												删除
											</button>
										</td>
									</tr>
							...
							<div class="col-md-4 col-sm-4">
								<div class="dataTables_paginate paging_simple_numbers pgt-page-box">
									...
									<ul class="pagination" id="pagination">
										...
										<li class="paginate_button"><a
												href="/tender/tenderList?currentIndex=${paginationBean.maxIndex}">末页</a></li>
