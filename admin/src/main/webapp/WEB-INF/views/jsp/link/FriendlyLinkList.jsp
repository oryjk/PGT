                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="actions btn-set">
                                <button class="btn green-haze btn-circle"  onclick="javascript:window.location.href='/friendlyLink/addFriendlyLinkUI';"><i class="fa fa-plus"></i> 新增</button>
                            </div>
                        </div>
                            ...
                            <div id="sample_3_wrapper" class="dataTables_wrapper no-footer">
                                <div class="table-scrollable productlist-box">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                        ...
                                        <c:forEach items="${LinkList}" var="frinedlyLink">
                                            ...
                                            <tr class="gradeX odd" role="row">
                                                ...
                                                <td>
                                                    <button class="btn btn-xs green btn-circle" onclick="javascript:window.location.href='/friendlyLink/updateFriendlyLinkUI/${frinedlyLink.id}'" >修改</button>
                                                    <button class="btn btn-xs red btn-circle" onclick="javascript:window.location.href='/friendlyLink/delete/${frinedlyLink.id}'">删除</button>
                                                </td>
                                            </tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <div class="dataTables_info pgt-page-count" id="sample_3_info" role="status" aria-live="polite">
                                            ...
                                            条 到 第
                                            <span>${paginationBean.sqlStartIndex+fn:length(LinkList)}</span>
                                            条 共
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers pgt-page-box">
                                            ...
                                            <ul class="pagination" id="pagination">
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/friendlyLink/query?currentIndex=0">首页</a></li>
                                                <c:choose>
                                                    <c:when test="${paginationBean.maxIndex>5}">
                                                        <c:if test="${paginationBean.currentIndex>2 and paginationBean.currentIndex<paginationBean.maxIndex-3}">
                                                            ...
                                                            <li class="paginate_button ">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex-2}">${currentIndex-1}</a>
                                                            </li>
                                                            <li class="paginate_button ">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex-1}">${currentIndex}</a>
                                                            </li>
                                                            <li class="paginate_button active">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex}">${currentIndex+1}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex+2}">${currentIndex+3}</a>
                                                            </li>
                                                            <li class="paginate_button disabled">
                                                                <a href="javascript:;">...</a>
                                                            </li>
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex<3}">
                                                            ...
                                                            <c:forEach var="current" begin="1" end="${currentIndex+1}">
                                                                <li class="paginate_button <c:if test="${paginationBean.currentIndex+1==current}">active</c:if> ">
                                                                    <a href="/friendlyLink/query?currentIndex=${current-1}">${current}</a>
                                                                </li>
                                                            </c:forEach>
                                                            <li class="paginate_button">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex+4>paginationBean.maxIndex}">
                                                            ...
                                                            <li class="paginate_button">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex-2}">${currentIndex-2}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/friendlyLink/query?currentIndex=${currentIndex-1}">${currentIndex-1}</a>
                                                            </li>
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/friendlyLink/query?currentIndex=${paginationBean.maxIndex}">末页</a></li>

                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <form class="dataTables_filter pgt-goto-page" action="/friendlyLink/query" method="get">
                                            <label>
