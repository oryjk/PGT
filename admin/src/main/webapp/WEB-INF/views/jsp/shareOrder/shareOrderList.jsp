...
<admin:container id="shareOrderList" pageJsPath="/resources/style/background-list.js" pageCssPath="/resources/style/background.css">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="table_managed.html">晒单管理</a>
                            <i class="fa fa-circle"></i>
                        </li>
                    </ul>
                </div>
                            ...
                            <div id="sample_3_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <div class="table-scrollable">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                        ...
                                        <c:forEach items="${shareOrderList}" var="shareOrder">
                                        <tr class="gradeX odd" role="row">
                                            ...
                                            <th>
                                               ${shareOrder.product.name}
                                            </th>
                                            <td>
                                                <fmt:formatDate value="${shareOrder.createDate}" type="both" pattern="yyyy-MM-dd hh:mm"/>
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    <c:if test="${shareOrder.isShow==true}">
                                                        <a class="btn btn-xs default btn-circle" href="javascript:;" data-toggle="dropdown" data-pgt-value="">
                                                            通过 </i>
                                                        </a>

                                                    </c:if>
                                                    <c:if test="${shareOrder.isShow==false}">
                                                        <a class="btn btn-xs default btn-circle" href="javascript:;" data-toggle="dropdown" data-pgt-value="">
                                                            未通过 </i>
                                                        </a>
                                                    </c:if>
                                            ...
                                            <td>
                                                <button class="btn btn-xs green btn-circle" onclick="javascript:window.location.href='/shareOrder/queryShareOrderById/${shareOrder.shareOrderId}';">审核</button>
                                                <button class="btn btn-xs red btn-circle" onclick="javascript:window.location.href='/shareOrder/deleteShareOrder/${shareOrder.shareOrderId}';">删除</button>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <div class="dataTables_info pgt-page-count" id="sample_3_info" role="status" aria-live="polite">
                                            ...
                                            条 到 第
                                            <span>${paginationBean.sqlStartIndex+fn:length(shareOrderList)}</span>
                                            条 共
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers pgt-page-box">
                                            ...
                                            <ul class="pagination" id="pagination">
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/shareOrder/query?currentIndex=0">首页</a></li>
                                                <c:choose>
                                                    <c:when test="${paginationBean.maxIndex>5}">
                                                        <c:if test="${paginationBean.currentIndex>2 and paginationBean.currentIndex<paginationBean.maxIndex-3}">
                                                            ...
                                                            <li class="paginate_button ">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex-2}">${currentIndex-1}</a>
                                                            </li>
                                                            <li class="paginate_button ">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex-1}">${currentIndex}</a>
                                                            </li>
                                                            <li class="paginate_button active">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex}">${currentIndex+1}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex+2}">${currentIndex+3}</a>
                                                            </li>
                                                            <li class="paginate_button disabled">
                                                                <a href="javascript:;">...</a>
                                                            </li>
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex<3}">
                                                            ...
                                                            <c:forEach var="current" begin="1" end="${currentIndex+1}">
                                                                <li class="paginate_button <c:if test="${paginationBean.currentIndex+1==current}">active</c:if> ">
                                                                    <a href="/shareOrder/query?currentIndex=${current-1}">${current}</a>
                                                                </li>
                                                            </c:forEach>
                                                            <li class="paginate_button">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex+4>paginationBean.maxIndex}">
                                                            ...
                                                            <li class="paginate_button">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex-2}">${currentIndex-2}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/shareOrder/query?currentIndex=${currentIndex-1}">${currentIndex-1}</a>
                                                            </li>
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/shareOrder/query?currentIndex=${paginationBean.maxIndex}">末页</a></li>

                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <form class="dataTables_filter pgt-goto-page" action="/shareOrder/query" method="get">
                                            <label>
