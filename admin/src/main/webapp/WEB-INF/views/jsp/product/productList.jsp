    ...
    --%>
        ...
        <admin:container id="productList" pageJsPath="/resources/product/product-list.js">
            ...
            class="form-control input-small input-inline select2-offscreen"
            tabindex="-1" title="">
            <option value="5">时间最近</option>
            <option value="15">时间最远</option>
            </select> </label>
            </div>
            </div>
            <div class="col-xs-2">
            ...
            class="form-control input-small input-inline select2-offscreen"
            tabindex="-1" title="">
            <option value="5">由低到高</option>
            <option value="15">由高到低</option>
            </select> </label>
            </div>
            </div>
            <div class="col-md-2 col-sm-2">
            ...
            <label>
            <input type="search" value="${currentIndex+1}" name="currentIndex" class="form-control input-xsmall
