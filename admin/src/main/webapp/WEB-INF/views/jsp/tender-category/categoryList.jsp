	...
	<div class="row">
		<div class="col-xs-12">
			<ul class="page-breadcrumb breadcrumb">
				...
				<li class="active">
					<a href="/tenderCategory/query">主分类</a>
				</li>
			</ul>
		</div>
	</div>
			...
			<div class="portlet light">
				<div class="portlet-title">
					...
					<div class="actions btn-set">
						<button class="btn green-haze btn-circle" data-pgt-btn="create" data-url="/tenderCategory/create"><i class="fa fa-plus"></i> 新增</button>
					</div>
				</div>
				<div class="portlet-body">
					<div id="sample_3_wrapper" class="dataTables_wrapper no-footer">
						...
						<div class="row">
								...
								<div class="dataTables_paginate paging_simple_numbers pgt-page-box">
									...
									<ul class="pagination" id="pagination">
										...
										<li class="paginate_button"><a
												href="/tenderCategory/query?currentIndex=0">首页</a></li>
										<c:choose>
											<c:when test="${paginationBean.maxIndex>5}">
												<c:if test="${paginationBean.currentIndex>2 and paginationBean.currentIndex<paginationBean.maxIndex-3}">
													...
													<li class="paginate_button ">
														<a href="/tenderCategory/query?currentIndex=${currentIndex-2}">${currentIndex-1}</a>
													</li>
													<li class="paginate_button ">
														<a href="/tenderCategory/query?currentIndex=${currentIndex-1}">${currentIndex}</a>
													</li>
													<li class="paginate_button active">
														<a href="/tenderCategory/query?currentIndex=${currentIndex}">${currentIndex+1}</a>
													</li>
													<li class="paginate_button">
														<a href="/tenderCategory/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
													</li>
													<li class="paginate_button">
														<a href="/tenderCategory/query?currentIndex=${currentIndex+2}">${currentIndex+3}</a>
													</li>
													<li class="paginate_button disabled">
														<a href="javascript:;">...</a>
													</li>
												...
												<c:if test="${paginationBean.currentIndex<3}">
													...
													<c:forEach var="current" begin="1" end="${currentIndex+1}">
														<li class="paginate_button <c:if test="${paginationBean.currentIndex+1==current}">active</c:if> ">
															<a href="/tenderCategory/query?currentIndex=${current-1}">${current}</a>
														</li>
													</c:forEach>
													<li class="paginate_button">
														<a href="/tenderCategory/query?currentIndex=${currentIndex+1}">${currentIndex+2}</a>
												...
												<c:if test="${paginationBean.currentIndex+4>paginationBean.maxIndex}">
													...
													<li class="paginate_button">
														<a href="/tenderCategory/query?currentIndex=${currentIndex-2}">${currentIndex-2}</a>
													</li>
													<li class="paginate_button">
														<a href="/tenderCategory/query?currentIndex=${currentIndex-1}">${currentIndex-1}</a>
													</li>
										...
										<li class="paginate_button"><a
												href="/tenderCategory/query?currentIndex=${paginationBean.maxIndex}">末页</a>
										</li>
							...
							<div class="col-xs-2">
								<form id="pageSubmit" class="dataTables_filter pgt-goto-page" action="/tenderCategory/query" method="get">
									<label>
