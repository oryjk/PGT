						...
						<div class="tender-info-body">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<p class="form-control-static">
										...
										<c:if test="${tender.tenderStatus==10}">
											在当期
										</c:if>

										<c:if test="${tender.tenderStatus==20}">
											已经绝当
										</c:if>

										<c:if test="${tender.tenderStatus==30}">
											商品已赎当
										</c:if>
										<c:if test="${tender.tenderStatus==-10}">
											准备审核发布
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									...
									<button type="button" class="btn default" @click="display='block'">产看已出售产品列表</button>
											...
											<tr class="gradeX odd" role="row">
												...
												<td>
													<button class="btn btn-xs green btn-circle"
															onclick="window.location.href='/tender/updateTenderProduct/${tender.tenderId}/${product.productId}'">修改
													</button>
													<button class="btn btn-xs red btn-circle" onclick="window.location.href='/tender/deleteTenderProduct/${product.productId}'">删除
													</button>
													<button class="btn btn-xs blue btn-circle"
															onclick="window.location.href='/tender/queryTenderByProductId/${tender.tenderId}/${product.productId}'">查看
													</button>
												</td>
											</tr>
										</c:forEach>
								...
								<div class="form-actions top">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<button type="button" class="btn default" @click="allProductDisplay='none'" style="float: right">隐藏列表</button>
										</div>
									</div>
								</div>
							</div>
