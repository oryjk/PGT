            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <a href="table_managed.html">背景管理</a>
                            <i class="fa fa-circle"></i>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="actions btn-set">
                                <button class="btn green-haze btn-circle" onclick="javascript:window.location.href='/pageBackground/createPageBackgroundUI/';"><i class="fa fa-plus"></i> 新增</button>
                            </div>
                        </div>
                            ...
                            <div id="sample_3_wrapper" class="dataTables_wrapper no-footer">
                                ...
                                <div class="table-scrollable">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                        ...
                                        <c:forEach items="${pageBackgroundList}" var="pageBackground">
                                        ...
                                        ${pageBackground.updateDate}
                                            ...
                                            <td>
                                                <button class="btn btn-xs green btn-circle" onclick="javascript:window.location.href='/pageBackground/updatePageBackgroundUI/${pageBackground.pageBackgroundId}';">修改</button>
                                                <button class="btn btn-xs red btn-circle" onclick="javascript:window.location.href='/pageBackground/deletePageBackground/${pageBackground.pageBackgroundId}';">删除</button>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <div class="dataTables_info pgt-page-count" id="sample_3_info" role="status" aria-live="polite">
                                            ...
                                            条 到 第
                                            <span>${paginationBean.sqlStartIndex+fn:length(pageBackgroundList)}</span>
                                            条 共
                                        ...
                                        <div class="dataTables_paginate paging_simple_numbers pgt-page-box">
                                            ...
                                            <ul class="pagination" id="pagination">
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/pageBackground/queryPageBackground?currentIndex=0">首页</a></li>
                                                <c:choose>
                                                    <c:when test="${paginationBean.maxIndex>5}">
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex<3}">
                                                            ...
                                                            <c:forEach var="current" begin="1" end="${currentIndex+1}">
                                                                <li class="paginate_button <c:if test="${paginationBean.currentIndex+1==current}">active</c:if> ">
                                                                    <a href="/pageBackground/queryPageBackground?currentIndex=${current-1}">${current}</a>
                                                                </li>
                                                            </c:forEach>
                                                            <li class="paginate_button">
                                                        ...
                                                        <c:if test="${paginationBean.currentIndex+4>paginationBean.maxIndex}">
                                                            ...
                                                            <li class="paginate_button">
                                                                <a href="/pageBackground/queryPageBackground?currentIndex=${currentIndex-2}">${currentIndex-2}</a>
                                                            </li>
                                                            <li class="paginate_button">
                                                                <a href="/pageBackground/queryPageBackground?currentIndex=${currentIndex-1}">${currentIndex-1}</a>
                                                            </li>
                                                ...
                                                <li class="paginate_button"><a
                                                        href="/pageBackground/queryPageBackground?currentIndex=${paginationBean.maxIndex}">末页</a></li>

                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-xs-2">
                                        <form class="dataTables_filter pgt-goto-page" action="/pageBackground/queryPageBackground" method="get">
                                            <label>
