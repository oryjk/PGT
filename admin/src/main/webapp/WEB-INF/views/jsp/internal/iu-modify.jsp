                    ...
                    <form action="<spring:url value="/internal/iu-modify" />" class="form-horizontal" method="post">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="login" value="${iu.login}" class="form-control" placeholder="5-12位的登陆账号">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">昵称</label>
                                <div class="col-md-4">
                                    <input type="text" name="name" value="${iu.name}" class="form-control" placeholder="用于称呼">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" name="phone" value="${iu.phone}" class="form-control" placeholder="11位手机号码">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-icon">
                                        ...
                                        <input type="email" name="email" value="${iu.email}" class="form-control" placeholder="Email">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
