                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <p class="form-control-static">
                                                        ¥&nbsp;<fmt:formatNumber value="${b2cOrder.total}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <p class="form-control-static">
                                                        <fmt:formatDate value="${b2cOrder.submitDate}"
                                            ...
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                                ...
                                                <c:forEach var="ci" items="${b2cOrder.commerceItems}">
                                                    <tr class="gradeX odd" role="row">
                                                        <td>${ci.id}</td>
                                                        <td>${ci.name}</td>
                                                        <td>¥&nbsp;<span><fmt:formatNumber value="${ci.salePrice}"
                                                                                           pattern="0.00"
                                                                                           type="number"/></span></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="search" class="form-control input-large input-inline"
                                                           placeholder="" aria-controls="sample_3">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                                    ...
                                                    <c:forEach var="transaction"
                                                               items="${b2cOrder.payment.transactions}">
                                                        <tr class="gradeX odd" role="row">
