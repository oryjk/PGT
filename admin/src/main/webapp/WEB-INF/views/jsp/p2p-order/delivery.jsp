                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="发货人" name="consignor"
                                           value="${commerceItem.delivery.consignor}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="物流公司名称" name="logistics"
                                           value="${commerceItem.delivery.logistics}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" placeholder="物流单号" name="trackingNo"
                                           value="${commerceItem.delivery.trackingNo}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="deliveryTimeStr" value="${commerceItem.delivery.deliveryTimeStr}"
                                           class="form-control input-middle input-inline" maxlength="16"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name="delivered" class="form-control">
                                        <option value="true" ${commerceItem.delivery.delivered ? 'selected' : ''}>已经发货
                                        </option>
                                        <option value="false" ${not commerceItem.delivery.delivered ? 'selected' : ''}>
                                            尚未发货
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name="received" class="form-control">
                                        <option value="true" ${commerceItem.delivery.received ? 'selected' : ''}>已经收货
                                        </option>
                                        <option value="false" ${not commerceItem.delivery.received ? 'selected' : ''}>
                                            尚未收货
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-actions top">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="/order/order-info?id=${param.id}">
