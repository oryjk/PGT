                                                            ...
                                                            <p class="form-control-static">
                                                                ...
                                                                <c:forEach var="item" items="${p2pOrder.commerceItems}">
                                                                    <c:set var="itemQuantity"
                                                                           value="${itemQuantity + item.quantity}"/>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <p class="form-control-static">
                                                                <fmt:formatDate value="${p2pOrder.submitDate}"
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                                        ...
                                                        <c:forEach var="ci" items="${p2pOrder.commerceItems}">
                                                            <tr class="gradeX odd" role="row">
                                                                ...
                                                                <td>
                                                                    <fmt:formatNumber value="${ci.salePrice}"
                                                                ...
                                                                <td>
                                                                    <c:choose>
                                                                        <c:when test="${not (p2pOrder.status eq 100) and ci.occupy}">
                                                                            <button data-pgt-btn="receipt1"
                                                                                    class="btn btn-xs yellow btn-circle">
                                                                                赔付
                                                                            </button>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                ...
                                                                <td>
                                                                    <fmt:formatDate
                                                                            value="${p2pInfo.actualDueDate == null ? p2pInfo.expectDueDate : p2pInfo.actualDueDate}"
                                                                            pattern="yyyy-MM-dd HH:mm:ss"/>
                                                                </td>
                                                                <td>
                                                                    <c:choose>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                                        ...
                                                        <tr role="row">
                                                            <th class="sorting_asc" tabindex="0"
                                                                aria-controls="sample_3" rowspan="1"
                                                        ...
                                                        <tr class="gradeX odd" role="row">
                                                            <td class="sorting_1">
                                                                <fmt:formatDate value="${p2pInfo.payTime}"
                                                                                pattern="yyyy-MM-dd HH:mm:ss"/>
                                                            </td>
                                                            <td>
                                                                <c:choose>
